            ...
            <div className="page-title-box d-flex align-items-center justify-content-between">
              ...
              <div className="page-title-right">
                <ol className="breadcrumb m-0">
                  <li className="breadcrumb-item active">Welcome to T-Hub Dashboard</li>
                </ol>
              </div>
              ...
              <CardBody>
                <div className="d-flex align-items-start">
                  ...
                  <div className="flex-1">
                    <div className="font-size-16 mt-2">TRAINERS</div>
                  </div>
                </div>
                <h4 className="mt-4">52 Tech Coaches </h4>
                <div className="row">
                  {/* <div className="col-7">
                    <p className="mb-0"><span className="text-success me-2"> 99% <i
            ...
            <Card>
              <CardBody>
                <div className="d-flex align-items-start">
                  ...
                  <div className="flex-1">
                    <div className="font-size-16 mt-2">TRAINEES</div>

                  </div>
                </div>
                <h4 className="mt-4">2,456+ Students</h4>
                <Row>
                  {/* <div className="col-7">
                    <p className="mb-0"><span className="text-success me-2">  <i
                      className="mdi mdi-arrow-up"></i> </span></p>
                  </div> */}
                  <div className="col-5 align-self-center">
                    <Progress
