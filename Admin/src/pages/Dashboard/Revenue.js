    ...
    return (
        <React.Fragment>
            <Col lg={6}>
                <Card>
                    <CardBody>
                        <h4 className="card-title mb-4"><b>Technical Hub location</b></h4>
                        ...
                        <Row>
                            ...
                            <Col sm={5} className="ms-auto">
                                <div className="mt-4 mt-sm-0">
                                    <h5>Located in:      <br></br> <u>Aditya University</u></h5>
                                    <p>Address: Technical Hub, Aditya Campus, Surampalem, Andhra Pradesh 533437</p>
