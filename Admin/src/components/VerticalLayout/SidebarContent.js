        ...
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/basic-elements">{props.t("BOOTCAMP")}</Link>
                </li>
                {/* <li>
                ...
                <li>
                  <Link to="/form-advanced">{props.t("TRAININGS")}</Link>
                </li>
                <li>
                  <Link to="/form-editors">{props.t("EVENTS")}</Link>
                </li>
                <li>
                  <Link to="/form-uploads">{props.t(" FILE UPLOAD")} </Link>
                </li>
                {/* <li>
                  <Link to="/form-xeditable">{props.t("COMPETITIONS")}</Link>
                </li> */}
                <li>
                  <Link to="/form-repeater">{props.t("COMPETITIONS")}</Link>
                </li>
                 {/* <li>
